...
describe('Rating Service', () => {
  ...
  describe('Calculate a rating for a given point', () => {
    // TODO
  });
  ...
  describe('Get rating based on wind and wave positions', () => {
    it('should get rating 1 for a beach with onshore winds', () => {
      const rating = defaultRating.getRatingBasedOnWindAndWavePositions(
        BeachPosition.E, BeachPosition.E
      ); 
    ...
    it('should get rating 3 for a beach with cross winds', () => {
      const rating = defaultRating.getRatingBasedOnWindAndWavePositions(
        BeachPosition.E, BeachPosition.S
      );
    ...
    it ('should get rating 5 for a beach with offshore winds', () => {
      const rating = defaultRating.getRatingBasedOnWindAndWavePositions(
        BeachPosition.E, BeachPosition.W
      );
  ...
  describe('Get position based on points location', () => {
    it('should get point based on east location', () => {
      const rating = defaultRating.getPointFromLocation(92);
      expect(rating).toBe(BeachPosition.E);
    });  

    
    it('should get point based on north location 1', () => {
      const rating = defaultRating.getPointFromLocation(360);
      expect(rating).toBe(BeachPosition.N);
    });  


    it('should get point based on north location 2', () => {
      const rating = defaultRating.getPointFromLocation(40);
      expect(rating).toBe(BeachPosition.N);
    });  

    
    it('should get point based on south location', () => {
      const rating = defaultRating.getPointFromLocation(200);
      expect(rating).toBe(BeachPosition.S);
    });  


    it('should get point based on west location', () => {
      const rating = defaultRating.getPointFromLocation(220);
